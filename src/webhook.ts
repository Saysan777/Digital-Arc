...
import { ReceiptEmailHtml } from './emails/ReceiptEmail'
 ...
 * @param req 
 * @param res 
 * Validates that this req is actually from stripe. That's why we stored the req.raw body in middleware in server.ts
 * Updates the `_isPaid` value of this order collection.
 * Sends receipt email.
 */
