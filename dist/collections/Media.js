...
exports.Media = {
    ...
    hooks: {
        beforeChange: [
            function (_a) {
                ...
                return __assign(__assign({}, data), { user: req.user._id });
            }
        ]
    },
    access: {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!req.user || (referer === null || referer === void 0 ? void 0 : referer.includes('sell'))) { // if is not user or is admin the return true as admin can see anything.
                            return [2 /*return*/, true];
                        }
    ...
    admin: {
        ...
        } // If user is not admin then hide this collection. This will hide collection from admin panel.
    },
    upload: {
        staticURL: '/media',
        staticDir: 'media',
