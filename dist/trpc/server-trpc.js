...
exports.publicProcedure = t.procedure; // api using this procedure can be called anytime from client
exports.privateProcedure = t.procedure.use(isAuth); // this can be only called when isAuth is present. (We can create middleware as per our need)
