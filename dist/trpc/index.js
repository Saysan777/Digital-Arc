...
var auth_router_1 = require("./endpoints/auth-router");
var server_trpc_1 = require("./server-trpc");
var query_validator_1 = require("../lib/validators/query-validator");
var get_payload_1 = require("../get-payload");
var payment_router_1 = require("./endpoints/payment-router");
// creating api using trpc.
exports.appRouter = (0, server_trpc_1.router)({
    auth: auth_router_1.authRouter,
    getInfiniteProducts: server_trpc_1.publicProcedure.input(zod_1.z.object({
        limit: zod_1.z.number().min(1).max(100),
        cursor: zod_1.z.number().nullish(),
        query: query_validator_1.QueryValidator
    })).query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var query, cursor, sort, limit, queryOpts, parsedQueryOpts, page, payload, _c, items, hasNextPage, nextPage;
        var input = _b.input;
